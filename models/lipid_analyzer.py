...
def analyze_lipid_profile(total_cholesterol, hdl, ldl, triglycerides):
    ...
    try:
        ...
        if ratio < 3.5:
            ...
            recommendations.append("Your Total Cholesterol to HDL ratio indicates elevated risk. Consider lifestyle modifications.")
    ...
    if non_hdl < 130:
        ...
        recommendations.append("Your Non-HDL cholesterol is high, indicating increased risk for heart disease.")
    ...
    if ldl >= 130 or triglycerides >= 150:
        recommendations.append("Reduce intake of processed foods, sugars, and saturated fats.")
        recommendations.append("Increase consumption of fiber-rich foods like fruits, vegetables, and whole grains.")
    
    if hdl < 40:
        recommendations.append("Regular aerobic exercise can help raise HDL levels.")
        recommendations.append("Consider including healthy fats like olive oil, nuts, and avocados in your diet.")
...
def get_population_percentile(total_cholesterol, hdl_cholesterol, ldl_cholesterol, triglycerides):
...
def is_valid_extraction(data):
    ...
    required_fields = ['total_cholesterol', 'hdl_cholesterol', 'ldl_cholesterol', 'triglycerides']
